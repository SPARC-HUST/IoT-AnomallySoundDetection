...
3- extracting spectrogram from signal
...
class Loader:
    ...
    def load(self, file_path):
        """Not used yet
        ---Incomplete --- comparing librosa.load and AudioSegment
        """
        # signal = librosa.load(file_path,
        #                       sr=self.sample_rate,
        #                       duration=self.duration,
        #                       mono=self.mono)[0]
        signal = AudioSegment.from_file(file_path, "wav")
        return signal
...
class SpectrogramExtractor:
    ...
    def __init__(self, filter_type, filter_cfg):
...
if __name__ == "__main__":
    ...
    padder = Padder()
    log_spectrogram_extractor = SpectrogramExtractor('gammatone', cfg.GAMMATONE_SETTING)
